...
function s.initial_effect(c)
    ...
    --Attaques multiples selon les matériels
    ...
    --Anti-Magie/Piège lors de l'attaque
    ...
    --Invocation Spéciale du Golem depuis le DECK si quitte le terrain
...
s.listed_names={CARD_ANCIENT_GEAR_GOLEM, 95735217} -- Golem original et Ultimate Pound
...
-- Filtre pour le Golem Rouages Ancients dans le Deck
